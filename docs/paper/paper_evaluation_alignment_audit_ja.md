...
**著者:** Tomoya Terai（DMM.com LLC）— <terai-tomoya@dmm.com>
...
1. ✅ (2026-07-24) 著者を記入済み: Tomoya Terai、DMM.com LLC、<terai-tomoya@dmm.com>。team name Komekami は abstract と本文に記載済み。登録チーム名と正確に一致するか最終確認する。
