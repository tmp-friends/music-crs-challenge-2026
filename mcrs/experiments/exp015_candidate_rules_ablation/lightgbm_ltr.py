"""exp015 専用 LightGBM 学習済みモデルで retrieval 候補を rerank する。"""
...
class LightGBMLTRReranker:
    ...
    def __init__(
        ...
        *,
        ...
        from mcrs.experiments.exp015_candidate_rules_ablation.features import LGBMFeatureBuilder
        ...
        *,
        ...
        Args:
            ...
            scores_by_source: ソース名 → {track_id: retrieval score} のマップ。
                source confidence feature を持つ feature_builder のみが使用する。
                None の場合は従来どおり score 由来特徴量を生成しない。
