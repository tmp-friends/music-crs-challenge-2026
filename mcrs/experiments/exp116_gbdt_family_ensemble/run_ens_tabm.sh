...
.venv/bin/python mcrs/experiments/exp116_gbdt_family_ensemble/ensemble_rerank.py \
  ...
  --xgb_n 2 --catboost_n 2 --tabm_n 1 --tabm_epochs 6 --tabm_device cuda \
  ...
  --output_report "${OUT}/ranker/report_ens_lxct.json" \
  --output_dev_full "${OUT}/ranker/dev_full_ens_lxct.json" \
  --output_blind_tracks "${OUT}/ranker/blindA_tracks_ens_lxct.json"
