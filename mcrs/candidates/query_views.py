"""BM25 query view 生成 helper（共有ライブラリ）。

exp014 由来。``mcrs/candidates/`` へ切り出した共有モジュールで、旧
``mcrs.experiments.exp014_lightgbm_ltr_reranker.query_views`` は re-export shim 経由で解決される。
"""
